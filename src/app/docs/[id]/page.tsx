...
export default async function DocsPostPage(props: any) {
  ...
  if (error || !post) {
    return (
      <div className="flex flex-col items-center justify-center h-full py-24 text-slate-500">
        ...
        <Link href="/docs" className="text-sm text-blue-400 hover:underline">← Back to all videos</Link>
      </div>
    )
  }
      ...
      <div className="flex-1 max-w-4xl px-6 py-12">
        ...
        <div className="pr-8">
          ...
          <nav className="mb-6 flex items-center gap-2 text-xs text-slate-600">
            <Link href="/docs" className="hover:text-slate-700 transition-colors">All</Link>
            {post.group_name && (
              <>
                <span>/</span>
          ...
          <div className="mt-12 pt-6 border-slate-300 border-t flex justify-between">
            <Link href="/docs" className="text-xs text-slate-600 hover:text-slate-700 transition-colors flex items-center gap-1.5">
